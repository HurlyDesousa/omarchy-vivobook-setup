...
BarWidget {
  ...
  readonly property var defaultIndicatorEntries: [ "Dictation", "ScreenRecording", "Reminder", "NightLight", "Dnd", "StayAwake", "KbdBacklight" ]
  ...
  Loader {
    id: layoutLoader
    sourceComponent: root.vertical ? verticalIndicatorsComponent : horizontalIndicatorsComponent
  }

  Component {
    id: horizontalIndicatorsComponent
  ...
  Component {
    id: verticalIndicatorsComponent
